...
export class StorePageComponent implements OnInit {
  ...
  constructor(private _storeInteraction: StoreItemInteractionService, private router: Router, private appServ: AppService) { }
  ...
  public getAllProducts() {
    this.appServ.getAllProducts().subscribe((products: any) => {
